...
export function HeroSection() {
  return (
    <section className="relative flex min-h-[calc(100vh-5rem)] items-center overflow-hidden py-16">
      ...
      <div className="mx-auto w-full max-w-7xl px-6">
        <div className="max-w-4xl">
          <motion.p
            ...
            className="inline-block bg-[var(--color-accent)] px-3 py-1 font-mono text-xs uppercase tracking-[0.12em] text-white"
          >
            W
          </motion.p>
          <motion.h1
            ...
            className="mt-4 font-display text-5xl uppercase leading-[0.95] text-[var(--color-text-dark)] sm:text-6xl md:text-7xl"
          >
          ...
          <motion.p
            ...
            className="mt-6 max-w-2xl text-base text-[var(--color-soft-gray)]"
          >
          ...
          <motion.p
            ...
            className="mt-8 font-mono text-xs uppercase tracking-[0.12em] text-[var(--color-soft-gray)]"
          >
      ...
      <motion.div
        className="pointer-events-none absolute -bottom-16 -right-20 h-80 w-80 rounded-full bg-[var(--color-accent)]/10 blur-3xl"
        animate={{ scale: [1, 1.08, 1], opacity: [0.35, 0.55, 0.35] }}
        transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }}
      />
      <div className="pointer-events-none absolute -left-16 top-20 h-52 w-52 border border-[var(--color-bg-secondary)]/50" />
    </section>
  );
}
